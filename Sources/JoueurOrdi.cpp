...
{
	CibleX_ = rand() % (nbColonnes) ; // Fonction qui choisie une colonne aléatoirement (coordonnée X)
	CibleY_ = rand() % (nbLignes) ; // Fonction qui choisie une ligne aléatoirement (coordonnée Y)
}
